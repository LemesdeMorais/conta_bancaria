...
public class ContaController implements ContaRepository{
	...
	@Override
	public void sacar(int numero, float valor) { //verificar se a conta existe, 

		var conta = buscarNaCollection(numero);
		if(conta != null) {
			if(conta.sacar(valor) == true) {
				System.out.printf("\nO saque no valor de %.2f%n, na conta numero: %d foi efetuado com sucesso! ", valor, numero );
			}
		}else {
			System.out.printf("\nA Conta número: %d não foi encontrada! %n", numero);
		}
	...
	public void depositar(int numero, float valor) {
		...
		if(conta != null) {
			conta.depositar(valor);
				System.out.printf("\nO deposito no valor de %.2f%n, na conta numero: %d foi efetuado com sucesso! ", valor, numero );
		}else {
			System.out.printf("\nA Conta número: %d não foi encontrada! %n", numero);
		}
	...
	public void transferir(int numeroOrigem, int numeroDestino, float valor) {
		...
		if(contaOrigem != null && contaDestino != null) {
			if(contaOrigem.sacar(valor) == true) {
				...
				System.out.printf("\nA Transferência no valor de %.2f, da conta número: %d para a conta número: %d, foi efetuada com sucesso!",
